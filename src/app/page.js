...
export default function Home() {
  const { handleGoogleSignInWithPopUp, full_name } = useStore(
    (state) => state.user
  );
  ...
  return (
    <main className="p-4 h-screen flex flex-col justify-center items-center">
      ...
      <div className="border border-green-600 p-10 rounded-lg">
        ...
        <LogIn />
        <div className="mb-5 font-light">I don't have an Account <Link href='/signup' className="underline text-blue-500 cursor-pointer">SignUp</Link> </div>
        <Button
